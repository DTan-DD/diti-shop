...
export default async function Search() {
  ...
  return (
    <form action="/search" method="GET" className="flex  items-stretch h-10 ">
      ...
      <Input className="flex-1 rounded-none dark:border-gray-200 bg-gray-100 text-black text-base h-full" placeholder={t("Header.Search Site", { name })} name="q" type="search" />
