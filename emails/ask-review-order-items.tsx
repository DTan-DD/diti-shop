                ...
                <Row key={item.product} className="mt-8">
                  <Column className="w-20">
                    <Link href={`${site.url}/product/${item.slug}`}>
                      <Img width="80" alt={item.name} className="rounded" src={item.image.startsWith("/") ? `${site.url}${item.image}` : item.image} />
                    </Link>
                  </Column>
                  ...
                  <Column align="right" className="align-top ">
                    <Button href={`${site.url}/product/${item.slug}#reviews`} className="text-center bg-blue-500 hover:bg-blue-700 text-white   py-2 px-4 rounded">
                      Review this product
                    </Button>
                  </Column>
                </Row>
