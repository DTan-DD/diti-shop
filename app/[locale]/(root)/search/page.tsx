    ...
    <div>
      <div className="my-2 bg-card md:border-b  flex-between flex-col md:flex-row ">
        <div className="flex items-center">
          ...
          {(q !== "all" && q !== "") || (category !== "all" && category !== "") || (tag !== "all" && tag !== "") || rating !== "all" || price !== "all" ? ` ${t("Search.for")} ` : null}
          {q !== "all" && q !== "" && '"' + q + '"'}
          ...
          &nbsp;
          {(q !== "all" && q !== "") || (category !== "all" && category !== "") || (tag !== "all" && tag !== "") || rating !== "all" || price !== "all" ? (
        ...
        <CollapsibleOnMobile title={t("Search.Filters")}>
          <div className="space-y-4">
            <div>
              ...
              <ul>
                <li>
                  <Link className={`${("all" === category || "" === category) && "text-primary"}`} href={getFilterUrl({ category: "all", params })}>
                    {t("Search.All")}
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul>
                <li>
                  <Link className={`${"all" === price && "text-primary"}`} href={getFilterUrl({ price: "all", params })}>
                    {t("Search.All")}
                  </Link>
                </li>
                {prices.map((p) => (
            ...
            <div>
              ...
              <ul>
                <li>
                  <Link className={`${("all" === tag || "" === tag) && "text-primary"}`} href={getFilterUrl({ tag: "all", params })}>
                    {t("Search.All")}
                  </Link>
                </li>
                {tags.map((t: string) => (
