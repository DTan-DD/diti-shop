...
export default function ReviewList({ userId, product }: { userId: string | undefined; product: IProduct }) {
    ...
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col gap-2">
          {reviews.length !== 0 && <RatingSummary avgRating={product.avgRating} numReviews={product.numReviews} ratingDistribution={product.ratingDistribution} />}
