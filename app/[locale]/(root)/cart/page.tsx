      ...
      <div className="grid grid-cols-1 md:grid-cols-4  md:gap-4">
        {items.length === 0 ? (
          <Card className="col-span-4 rounded-none">
            <CardHeader className="text-3xl  ">{t("Cart.Your Shopping Cart is empty")}</CardHeader>
            <CardContent>
              ...
              <Card className="rounded-none">
                <CardContent className="py-4 space-y-4">
                  {itemsPrice < freeShippingMinPrice ? (
                    ...
                    <div className="flex-1">
                      <span className="text-green-700">{t("Cart.Your order qualifies for FREE Shipping")}</span> {t("Cart.Choose this option at checkout")}
                    </div>
                  )}
