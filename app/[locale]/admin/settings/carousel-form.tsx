          ...
          {fields.map((field, index) => (
            <div key={field.id} className="flex justify-between gap-1 w-full  ">
              ...
              <div>
                ...
                {watch(`carousels.${index}.image`) && <Image src={watch(`carousels.${index}.image`)} alt="image" className=" w-full object-cover object-center rounded-sm" width={192} height={68} />}
