  ...
  settings: [
    {
      ...
      site: {
        name: "DiTi Shop",
        description: "DiTi Shop is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.",
        ...
        email: "tan.ddd03979@gmail.com",
        address: "KP6, Phường Linh Trung, Thủ Đức, TP.HCM",
        phone: "+1 (123) 456-7890",
      },
      carousels: [
        {
      ...
      defaultLanguage: "vi",
      availableCurrencies: [
        { name: "VNĐ", code: "VND", symbol: "₫", convertRate: 25000 },
        {
